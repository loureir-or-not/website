  ...
  return (
    <article className="flex flex-col gap-4">
      ...
      <Card>
        <h2>This website</h2>
        <p>
          You&apos;re looking at it right now! It is written entirely in
          TypeScript, Next.js and TailwindCSS. It is also hosted on Vercel due
      ...
      <p>
        ...
        <Link href="mailto:loureiror@proton.me">Contact me!</Link> I&apos;d love
        to hear from you!
      </p>
    </article>
  );
